\section{Entwurf des Cloud-BI Systems} \label{sec:entwurfBIArchitektur}

\subsection{Auswahl der BI-Komponenten} \label{sec:konzeption:evaAuswertung}
...
\subsection{Vorstellung eines vollständigen Konzepts}
