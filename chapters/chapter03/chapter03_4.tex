...
Mit einer zusätzlichen Windows \ac{vm} in dem virtuellen Netzwerk, auf der zwei Anwendungen installiert werden, kann es den Diensten \textit{Power BI} und \textit{Purview} ermöglicht werden, auf das geschützte \ac{dwh} zuzugreifen \cite[vgl.][]{gunnarsson_pro_2020, msdoc_22_purviewSHIR}. Der Dienst \textit{Azure Bastion} ermöglicht den Aufbau einer sicheren RDP-Verbindung zu \ac{vm} über das Azure Portal \cite[vgl.][]{herath_azure_2022}.
...
Das vollständige Konzept für die BI-Architektur, unter Berücksichtigung der Netzwerksicherheit, kann in Abbildung~\ref{fig:chap03_4_konzeptArchitektur} gefunden werden.
 
 \begin{figure}[htbp]
 \centering
 \includegraphics[width=\textwidth]{gfx/konzept_2.png}
 \caption{Konzept für \textbf{sichere} BI-Architektur in Azure}
