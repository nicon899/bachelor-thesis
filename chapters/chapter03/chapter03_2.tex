...
Der Zugriff auf die Komponenten von \ac{aml} kann über \ac{rbac} kontrolliert werden \cite{wu_manage_2021}. Auch die Daten sind während Übertragung und Speicherung verschlüsselt \cite{msdoc_21_aml_dataEncryption}.
