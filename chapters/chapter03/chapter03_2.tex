...
\item Die Datenbanken \textbf{PostgreSQL}, \textbf{MySQL} und \textbf{MariaDB} werden nicht berücksichtigt, da mit Azure SQL bereits eine relationale Datenbank zur Auswahl steht. Letztere hat den Vorteil, dass Skripte und Kenntnisse in T-SQL in das neue System übernommen werden können.
\end{itemize}