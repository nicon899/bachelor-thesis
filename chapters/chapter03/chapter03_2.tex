...
Die \textit{Azure Storage Client Library} bietet die Möglichkeit fehlgeschlagene Abfragen, zum Beispiel wegen eines Server-Timeouts, automatisch zu wiederholen. Alternativ kann beim Zugriff über \ac{rest}-API eine eigene Wiederholungslogik bei Fehlern implementiert werden \cite{reagan_web_2018}. 
...
% Sicherheit wird durch die Verschlüsselung der Daten in Bewegung und in Ruhe und durch die Verwendung von \ac{rbac} erreicht \cite{msdoc_21_hdIns_security}.
