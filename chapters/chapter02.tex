...
Neben den internen Gründen gibt es aber auch fachliche Argumente für die Wahl der Azure Cloud.
\textit{...}
...
\subsection{Azure Active Directory} \label{subsec:grundlagen:azure:sicherheitUndDatenschutz:aad}
...
\subsection{Microsoft Defender for Cloud} \label{subsec:grundlagen:azure:sicherheitUndDatenschutz:asc}
